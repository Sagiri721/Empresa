...
public class EnergySystem : MonoBehaviour
{
    ...
    public bool Use(int usedEnergy) // Isto retorna bool para que, se a ação for inválida e consumir demasiada energia, o programa não execute as animações
    {                               // da abilidade e essas merdas.
